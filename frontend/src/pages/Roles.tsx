...
const Roles: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      try {
        // Fetch permissions - we'll assume there's an endpoint for this
        // If not available in your API, this can be adjusted
        ...
        // Create some mock permissions for the demo if the endpoint doesn't exist
        const mockPermissions = [
          { id: '1', name: 'user.read', description: 'Read users', resource: 'user', action: 'read' },
          { id: '2', name: 'user.create', description: 'Create users', resource: 'user', action: 'create' },
          ...
          { id: '5', name: 'role.read', description: 'Read roles', resource: 'role', action: 'read' },
          { id: '6', name: 'role.create', description: 'Create roles', resource: 'role', action: 'create' },
          { id: '7', name: 'role.update', description: 'Update roles', resource: 'role', action: 'update' },
          { id: '8', name: 'role.delete', description: 'Delete roles', resource: 'role', action: 'delete' },
          { id: '9', name: 'organization.read', description: 'Read organizations', resource: 'organization', action: 'read' },
          { id: '10', name: 'organization.create', description: 'Create organizations', resource: 'organization', action: 'create' },
          { id: '11', name: 'organization.update', description: 'Update organizations', resource: 'organization', action: 'update' },
          { id: '12', name: 'organization.delete', description: 'Delete organizations', resource: 'organization', action: 'delete' },
        ];
