...
type RoleRepository interface {
	...
	FindMany(ctx context.Context, filter Filter, options QueryOptions) ([]models.Role, error)
...
type PermissionRepository interface {
	...
	FindMany(ctx context.Context, filter Filter, options QueryOptions) ([]models.Permission, error)
...
type RoleService interface {
	...
	GetRoles(ctx context.Context, filter Filter, pagination map[string]int) ([]models.Role, int, error)
	...
	UpdateRole(ctx context.Context, id string, updates map[string]interface{}) (*models.Role, error)
...
type PermissionService interface {
	...
	GetPermissions(ctx context.Context, filter Filter, pagination map[string]int) ([]models.Permission, int, error)
